...
const Terminal = () => {
  ...
  useEffect(() => {
    const fetchFearGreed = async () => {
      try {
        ...
        console.log('Failed to fetch Fear & Greed index:', error);
      }
    };
  ...
  const hideNewsPanel = activeTab === 'PORTFOLIO' || activeTab === 'SETTINGS' || (activeTab !== 'SWAP' && activeTab !== 'BRIDGE' && !settings.showNewsPanel);
  const hideStatsPanel = activeTab === 'PORTFOLIO' || !settings.showStatsPanel;
    ...
    <div className="terminal">
      ...
      <div className="terminal-header">
        <div className="header-left">
          <span className="header-logo">GUV TERMINAL</span>
      ...
      {/* Main Content Grid */}
      <div className={`terminal-content ${hideNewsPanel ? 'no-news' : ''} ${hideStatsPanel || (activeTab !== 'CRYPTO' && activeTab !== 'SOLANA') ? 'no-stats' : ''} ${activeTab === 'PORTFOLIO' ? 'portfolio-mode' : ''} ${activeTab === 'SETTINGS' ? 'settings-mode' : ''} ${activeTab === 'BRIDGE' ? 'bridge-mode' : ''}`}>
        ...
        <div className="panel panel-center">
          <div className="panel-header">
            <span className="panel-title">
              {activeTab === 'PORTFOLIO' ? 'PORTFOLIO' : activeTab === 'SETTINGS' ? 'SETTINGS' : activeTab === 'BRIDGE' ? 'BRIDGE' : 'MARKET DATA'}
            </span>
